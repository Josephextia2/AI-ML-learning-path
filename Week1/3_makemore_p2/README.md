...
As using all input data for training at once is not efficient (slow), sampling the input data (32, 64, 128, ...) should be considered. For a proper training, the final loss of the sample-training model will not have too much differences from the actual loss.  
